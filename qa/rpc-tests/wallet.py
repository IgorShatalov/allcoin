...
#   c) node1 mines 32 blocks, so now node 0 has 60001alc, node 1 has 4250alc, node2 has none.
#   d) node0 sends 601 alc to node2, in two transactions (301 alc, then 300 alc).
