...
RESOURCES += src/qt/allcoin.qrc src/qt/allcoin_locale.qrc

TRANSLATIONS += src/qt/locale/allcoin_bg.ts \
                src/qt/locale/allcoin_de.ts \
                src/qt/locale/allcoin_en.ts \
                src/qt/locale/allcoin_es.ts \
                src/qt/locale/allcoin_fi.ts \
                src/qt/locale/allcoin_fr.ts \
                src/qt/locale/allcoin_it.ts \
                src/qt/locale/allcoin_ja.ts \
                src/qt/locale/allcoin_pl.ts \
                src/qt/locale/allcoin_pt.ts \
                src/qt/locale/allcoin_ru.ts \
                src/qt/locale/allcoin_sk.ts \
                src/qt/locale/allcoin_sv.ts \
                src/qt/locale/allcoin_vi.ts \
                src/qt/locale/allcoin_zh_CN.ts \
                src/qt/locale/allcoin_zh_TW.ts
