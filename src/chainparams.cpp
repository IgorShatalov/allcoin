...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 1257;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // ALLCOIN starting difficulty is 1 / 2^12
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d2bd44f4c589b8a719b148169f0d31a4d355ecc9c69a976c4d4ea4acb9a696934b584e7ca4fc277e99aee2eaec962e35dfa1baae81a4969a091441099a3e1cc9") << OP_CHECKSIG;
    ...
    */
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zalc to be stakable
...
public:
    ...
    */
        ...
        // Testnet allcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet allcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // ALLCOIN: 1 day
        nTargetSpacing = 1 * 60;        // ALLCOIN: 1 minutes
