...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AllCoin Core allcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  allcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded allcoin transaction") + "\n" +
                               "  allcoin-tx [options] -create [commands]   " + _("Create hex-encoded allcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded allcoin transaction
