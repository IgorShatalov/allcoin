...
/**
 * ALLCOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzalcseed(const UniValue& params, bool fHelp);
extern UniValue getzalcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzalc(const UniValue& params, bool fHelp);
extern UniValue dzalcstate(const UniValue& params, bool fHelp);
