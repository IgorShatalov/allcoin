...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "ALLCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ALLCOIN features */
        {"allcoin", "masternode", &masternode, true, true, false},
        {"allcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"allcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"allcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"allcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"allcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"allcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"allcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"allcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"allcoin", "startmasternode", &startmasternode, true, true, false},
        {"allcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"allcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"allcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"allcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"allcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"allcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"allcoin", "mnbudget", &mnbudget, true, true, false},
        {"allcoin", "preparebudget", &preparebudget, true, true, false},
        {"allcoin", "submitbudget", &submitbudget, true, true, false},
        {"allcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"allcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"allcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"allcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"allcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"allcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"allcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"allcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"allcoin", "mnsync", &mnsync, true, true, false},
        {"allcoin", "spork", &spork, true, true, false},
        {"allcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzalcseed", &getzalcseed, false, false, true},
        {"zerocoin", "setzalcseed", &setzalcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzalc", &searchdzalc, false, false, true},
        {"zerocoin", "dzalcstate", &dzalcstate, false, false, true}
...
{
    return "> allcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:50110/\n";
}
