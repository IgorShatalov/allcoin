                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzALCPathCustom = GetArg("-zalcbackuppath", "");
    ...
    if(!strzALCPathCustom.empty()) {
        ui->wallet_customzalcbackuppath->setText(QString::fromStdString(strzALCPathCustom));
        ui->wallet_customzalcbackuppath_label->setVisible(true);
        ui->wallet_customzalcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzALCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ALLCOIN RPC console.") + "<br>" +
