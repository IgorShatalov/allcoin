...
/** Utility functions used by the ALLCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render ALLCOIN addresses in monospace font
...
// Parse "allcoin:" URI into recipient object, return true on successful parsing
