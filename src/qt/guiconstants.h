...
/* AllCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ALLCOIN"
#define QAPP_ORG_DOMAIN "allcoin.org"
#define QAPP_APP_NAME_DEFAULT "ALLCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "ALLCOIN-Qt-testnet"
