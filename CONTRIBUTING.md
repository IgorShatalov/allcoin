Contributing to ALLCOIN Core
============================

The ALLCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ALLCOIN Core project, and is not to be
confused with overall ALLCOIN Network Protocol consensus changes.

Whether a pull request is merged into ALLCOIN Core rests with the project merge
...
Patches that change ALLCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the ALLCOIN consensus, it must have been
...
The project leader is the release manager for each ALLCOIN Core release.
