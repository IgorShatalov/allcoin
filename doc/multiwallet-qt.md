...
In order to support loading of multiple wallets in allcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is allcoin.cpp.
...
Changes to allcoin.cpp
----------------------
allcoin.cpp is the entry point into allcoin-qt, and as such, will require some minor modifications to provide hooks for
