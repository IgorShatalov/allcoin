...
This mechanism has been integrated into Bitcore-Node-ALLCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ALLCOIN-Project/insight-api-allcoin#web-socket-api](https://github.com/ALLCOIN-Project/insight-api-allcoin#web-socket-api) 
* API: [https://github.com/ALLCOIN-Project/insight-api-allcoin#swifttx-transactions](https://github.com/ALLCOIN-Project/insight-api-allcoin#swifttx-transactions) 
...
By default, the ALLCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ALLCOIN Core daemon:
